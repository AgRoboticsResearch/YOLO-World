...
def parse_args():
    ...
    parser.add_argument('--config', default='F:\doctor\YOLO-World\configs\pretrain\yolo_world_l_t2i_bn_2e-4_100e_4x8gpus_obj365v1_goldg_train_lvis_minival.py',help='test config file path')
    parser.add_argument('--checkpoint', default='F:\doctor\YOLO-World\pretrained_weights/yolow-v8_l_clipv2_frozen_t2iv2_bn_o365_goldg_pretrain.pth', help='checkpoint file')
    parser.add_argument('--image', default='F:\doctor\YOLO-World\data_wyn\im', help='image path, include image file or dir.')
    parser.add_argument(
        '--text', default='strawberry,leaf,flower,stem,others',
    ...
    parser.add_argument('--output-dir',
                        default='F:\doctor\YOLO-World\output_wyn\image_demo/20240308',
...
def inference_detector(runner,
    ...
    #print('image_demo_wyn.py  line 92--detections---', detections)
    labels = [
...
if __name__ == '__main__':
    ...
    if args.text.endswith('.txt'):
        ...
        #print('line 164 texts',texts) #[['strawberry'], ['leaf'], ['flower'], ['stem'], ['others'], [' ']]
