...
def parse_args():
    ...
    parser.add_argument(
        '--work-dir',
        default='F:\doctor\YOLO-World\output_wyn\image_demo/human_head1',
...
def run_image(runner,
              ...
              score_thr,
              nms_thr,
              image_path='F:\doctor\YOLO-World\dog.jpeg'):
...
if __name__ == '__main__':
    ...
    demo(runner, args)
#
#python demo.py F:\doctor\YOLO-World\configs\segmentation\yolo_world_seg_m_dual_vlpan_2e-4_80e_8gpus_seghead_finetune_lvis.py F:\doctor\YOLO-World\checkpoint\yolo_world_seg_m_dual_vlpan_2e-4_80e_8gpus_seghead_finetune_lvis-7bca59a7.pth