...
def parse_args():
    ...
    parser.add_argument('--config', default='F:\doctor\YOLO-World\configs\pretrain\yolo_world_s_dual_vlpan_l2norm_2e-3_100e_4x8gpus_obj365v1_goldg_train_lvis_minival.py', help='test config file path')
    parser.add_argument('--checkpoint', default='F:\doctor\YOLO-World\checkpoint\yolo_world_s_clip_base_dual_vlpan_2e-3adamw_32xb16_100e_o365_goldg_train_pretrained-18bea4d2.pth', help='checkpoint file')
    parser.add_argument('--image', default='F:\doctor\YOLO-World\data\images/bus.jpg', help='image path, include image file or dir.')
    parser.add_argument(
        't--ext',default='person,dog,cat', 
    ...
    parser.add_argument('--output-dir',
                        default='F:\doctor\YOLO-World\output_wyn\image_demo/20240307',
